...
**Objective:** Give analysts a **high-level view of overall fraud activity**.

Typical visuals:

* Total transactions over time
* Distribution of risk scores
* Count of alerts by severity (High / Medium / Low)

**Insights/Use:**

> [Add your findings here – e.g., spikes in medium/high alerts, periods of high transaction volume, or unusual trends.]

---

## Page 2: Geographic & Merchant Risk Analysis

**Objective:** Identify **geographic clusters and high-risk merchants**.

Typical visuals:

* Transactions per city/branch
* Alerts by merchant risk tier
* Heatmaps showing concentration of suspicious activity

**Insights/Use:**

> [Add your findings here – e.g., cities with unusually high high-risk transactions, merchants consistently triggering alerts.]
